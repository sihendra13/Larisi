...
function buildSilarisSystemPrompt() {
  ...
  var baseRules = [
    ...
    'Gunakan struktur 3 seksi ini, tapi isi tiap seksi dengan bahasa coach yang mengalir:',
    '',
    '📊 PERFORMA SEKARANG',
    ...
    '',
    '💡 INSIGHT UTAMA',
    'Engagement-nya top, tapi reach-nya masih sangat lokal. Ini artinya kontennya sudah bagus,',
