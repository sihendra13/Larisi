...
async function _callSilarisCompetitor(handle, platform, agg) {
  ...
  var sysPrompt = [
    ...
    'comp_category: WAJIB deteksi HANYA dari kata kunci di username/handle. JANGAN gunakan asumsi visual. Cek berurutan: (1) hotel/resort/penginapan/villa/homestay/bnb→"hotel & akomodasi" [BUKAN properti]. (2) resto/warung/food/bakso/nasi/makan/rm/mie→"kuliner" [BUKAN retail]. (3) kafe/coffee/kopi/boba/minuman/espresso→"kafe" [BUKAN kuliner]. (4) fashion/hijab/baju/outfit/clothing/batik/thrift→"fashion" [BUKAN retail]. (5) salon/beauty/skincare/makeup/kosmetik/spa/nail/lash→"beauty" [BUKAN jasa]. (6) barber/barbershop/cukur/pangkas→"barber" [BUKAN beauty atau jasa]. (7) gym/fitness/olahraga/sport/yoga/futsal/badminton→"olahraga" [BUKAN kesehatan]. (8) klinik/dokter/kesehatan/apotek/herbal/wellness/medis→"kesehatan" [BUKAN retail]. (9) wisata/travel/tur/destinasi/liburan/piknik→"wisata" [BUKAN jasa]. (10) properti/rumah/kost/kontrakan/ruko/kavling/realestate→"properti" [BUKAN hotel]. (11) motor/bengkel/mobil/otomotif/sparepart/variasi→"otomotif". (12) kursus/les/sekolah/pendidikan/training/bimbel/kampus→"pendidikan". (13) museum/galeri/art/seni/budaya/pameran/exhibition→"seni budaya" [BUKAN komunitas]. (14) komunitas/community/club/squad/organisasi/yayasan/paguyuban/base→"komunitas" [BUKAN seni budaya]. (15) musik/band/dj/entertainment/konser/manggung→"hiburan" [BUKAN seni budaya]. (16) foto/photography/photographer/studio foto/kamera→"fotografi" [BUKAN seni budaya]. (17) wedding/pernikahan/bridal/weddingorganizer/dekorasi→"wedding & event" [BUKAN fashion]. (18) pet/hewan/anjing/kucing/vet/grooming→"pet". (19) media/berita/news/konten/podcast/contentcreator→"media & konten". (20) teknologi/startup/digital/app/software/developer/it→"teknologi". (21) jasa/konsultan/laundry/reparasi/sablon/percetakan→"jasa". (22) toko/retail/shop/olshop/store/market→"retail". Kosong jika benar-benar tidak ada kata kunci yang cocok di username.',
