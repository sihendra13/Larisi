...
var CAPTION_TEMPLATES = {
  "ig-story": {
    ...
    "Literature & Education": [
      "{greeting} 📚\n\nBuku yang tepat bisa mengubah cara pandangmu dalam semalam!\n\nKoleksi terlengkap di {loc} — dari novel, non-fiksi, buku akademik, hingga buku anak. Semua dikurasi oleh pembaca yang serius. Hanya {dist}km dari kamu.\n\n{cta}\n\n#BukuLokal #LiterasiIndonesia #ReadingCommunity",
      "{greeting} 🎓\n\nInvestasi terbaik adalah investasi pada pengetahuan.\n\nToko buku kami di {loc} tidak hanya menjual buku — kami membantu kamu menemukan bacaan yang benar-benar relevan untuk tujuanmu. Konsultasi rekomendasi gratis. Hanya {dist}km.\n\n{cta}\n\n#BukuBerkualitas #LiterasiLokal #InvestasiIlmu",
      "{greeting} ⚡\n\nNew arrival buku bulan ini — stok terbatas!\n\nJudul-judul bestseller dan koleksi langka baru masuk ke toko kami di {loc}. Hanya {dist}km dari kamu. Jangan sampai kehabisan edisi pertama.\n\n{cta}\n\n#NewArrivalBuku #BukuTerbatas #ReadersOfInstagram"
    ],
    "High-end Goods": [
      "{greeting} 👜\n\nLuxury bukan sekadar harga — ini soal kualitas yang bertahan seumur hidup.\n\nKoleksi premium kami di {loc} dipilih dengan standar ketat. Setiap item dilengkapi sertifikat keaslian dan layanan after-sales eksklusif. Hanya {dist}km dari kamu.\n\n{cta}\n\n#LuxuryLokal #PremiumGoods #InvestasiGaya",
      "{greeting} ✨\n\nMereka yang paham kualitas tidak perlu diyakinkan dua kali.\n\nKoleksi luxury kami di {loc} dipilih langsung dari brand heritage terpercaya. Layanan personal shopper tersedia — karena kamu layak mendapat pengalaman belanja yang berbeda. Hanya {dist}km.\n\n{cta}\n\n#PersonalShopper #LuxuryLifestyle #PremiumExperience",
      "{greeting} 🔔\n\nKoleksi eksklusif baru tiba — sangat terbatas!\n\nHanya tersedia untuk {dist}km pertama dari {loc}. Item luxury ini tidak akan restock setelah habis. Hubungi kami untuk reservasi sebelum kehabisan.\n\n{cta}\n\n#LimitedLuxury #ExclusiveCollection #PremiumOnly"
    ],
    "Wedding/Jewelry": [
      "{greeting} 💍\n\nMomen terpenting dalam hidupmu layak perhiasan yang sempurna!\n\nKoleksi cincin, kalung, dan perhiasan pengantin dari pengrajin terpercaya di {loc}. Custom design tersedia — wujudkan cincin impianmu persis seperti yang kamu bayangkan. Hanya {dist}km.\n\n{cta}\n\n#CincinNikah #PerhiasanLokal #WeddingJewelry",
      "{greeting} ✨\n\nPerhiasan bukan sekadar aksesori — ini kenangan yang bertahan selamanya.\n\nDesain custom, bahan gold certified, pengerjaan presisi oleh pengrajin berpengalaman di {loc}. Konsultasi desain gratis, tanpa tekanan. Hanya {dist}km dari kamu.\n\n{cta}\n\n#CustomJewelry #PerhiasanPengantin #GoldCertified",
      "{greeting} ⏰\n\nPromo spesial pasangan — konsultasi & desain gratis bulan ini!\n\nHanya untuk 10 pasangan pertama di {loc}. Sudah 6 slot terisi. Wujudkan perhiasan impian sebelum slot habis. Hanya {dist}km.\n\n{cta}\n\n#PromoWedding #CincinCustom #BookSekarang"
    ],
    "Banking/Finance": [
      "{greeting} 💰\n\nFinancial freedom dimulai dari langkah pertama yang tepat!\n\nKonsultasi keuangan di {loc} — dari perencanaan investasi, asuransi, hingga manajemen portofolio. Tidak ada biaya konsultasi untuk pertemuan pertama. Hanya {dist}km dari kamu.\n\n{cta}\n\n#FinancialLiteracy #InvestasiLokal #CerdasKeuangan",
      "{greeting} 📈\n\nUang yang tidak dikelola dengan benar akan diam di tempat.\n\nTim konsultan keuangan kami di {loc} membantu kamu memahami investasi yang sesuai profil risiko dan tujuan finansialmu — tanpa jargon yang membingungkan. Hanya {dist}km.\n\n{cta}\n\n#KonsultanKeuangan #InvestasiCerdas #FinancialGoals",
      "{greeting} 🔔\n\nWorkshop literasi keuangan GRATIS — akhir pekan ini!\n\nTerbatas untuk 30 peserta di {loc}. Materi: investasi pemula, manajemen utang, dan perencanaan pensiun. Sudah 22 kursi terisi. Hanya {dist}km dari kamu.\n\n{cta}\n\n#WorkshopGratis #LiterasiKeuangan #InvestasiPemula"
    ],
    "Music/Events": [
      "{greeting} 🎵\n\nPengalaman konser lokal terbaik ada di {loc}!\n\nLineup artis pilihan, sound system profesional, dan venue yang nyaman. Bukan sekadar nonton — ini pengalaman yang akan kamu ceritakan. Hanya {dist}km dari sini.\n\n{cta}\n\n#MusicLokal #KonserLokal #EventIndonesia",
      "{greeting} 🎤\n\nDukung musisi lokal {loc} yang karyanya setara internasional!\n\nEvent kami menghadirkan artis independen terbaik daerah — live performance yang jujur dan penuh energi. Tiket tersedia terbatas. Hanya {dist}km.\n\n{cta}\n\n#SupportMusikaLokal #IndieScene #LiveMusic",
      "{greeting} 🎉\n\nEarly bird tiket habis dalam 3 jam — regular price berlaku sekarang!\n\nEvent di {loc} ini hanya sekali. Tidak ada rerun. Jangan sampai menyesal tidak hadir. Hanya {dist}km dari kamu.\n\n{cta}\n\n#EventLokal #TiketTerbatas #GasSekarang"
    ],
    "Sustainability": [
      "{greeting} 🌿\n\nPilihan konsumsi kamu hari ini menentukan bumi seperti apa yang ditinggalkan untuk generasi berikutnya.\n\nProduk eco-friendly dan sustainable dari {loc} — bahan ramah lingkungan, packaging minimal waste, diproduksi etis. Hanya {dist}km dari kamu.\n\n{cta}\n\n#EcoFriendly #SustainableLokal #GoGreen",
      "{greeting} ♻\n\nSustainable living tidak harus mahal — harus tepat.\n\nProduk pilihan kami di {loc} sudah tersertifikasi ramah lingkungan. Setiap pembelian berkontribusi pada program penanaman pohon lokal. Hanya {dist}km.\n\n{cta}\n\n#ZeroWaste #EcoConscious #SustainableChoice",
      "{greeting} 🌱\n\nGerakan eco-friendly {loc} dimulai dari komunitas kita sendiri!\n\nPromo spesial untuk pembelian produk sustainable hari ini — hemat 20% dan gratis tote bag daur ulang. Stok terbatas. Hanya {dist}km dari kamu.\n\n{cta}\n\n#EcoPromo #SustainableLifestyle #GoGreenLokal"
    ],
    "General": [
  ...
  "tiktok": {
    ...
    "High-end Goods": [
      ...
      "KOLEKSI EKSKLUSIF BARU — stok sangat terbatas! 🔔\n\n{greeting}! Tidak akan restock setelah habis. Di {loc}, {dist}km. Hubungi kami sekarang!\n\n{cta}"
    ],
    "Wedding/Jewelry": [
      "POV: Custom cincin nikah persis seperti yang diimpikan dan hasilnya melebihi ekspektasi 💍\n\n{greeting}! Pengrajin perhiasan terpercaya di {loc}, {dist}km dari kamu.\n\n{cta}",
      ...
      "Slot konsultasi design perhiasan GRATIS hampir penuh! ⏰\n\n{greeting}! Hanya 10 slot, sudah 6 terisi. Hubungi kami sekarang — {dist}km dari {loc}.\n\n{cta}"
    ],
    "Banking/Finance": [
      ...
      "Duit yang nggak dikelola dengan benar itu diam di tempat 💰\n\n{greeting}! Tim keuangan kami di {loc} bantu kamu mulai dari mana pun kondisinya. {dist}km.\n\n{cta}",
    ...
    "Music/Events": [
      ...
      "Support musisi lokal bukan karena terpaksa — karena mereka emang keren 🎤\n\n{greeting}! Event kami di {loc} hadirkan artis indie terbaik daerah. {dist}km.\n\n{cta}",
    ...
    "Sustainability": [
      ...
      "Sustainable living itu bukan tren — ini keputusan 🌱\n\n{greeting}! Produk eco-certified dari {loc}, {dist}km. Setiap beli = tanam pohon lokal.\n\n{cta}",
  ...
  "youtube": {
    ...
    "Literature & Education": [
      "{greeting}! Buku yang tepat bisa mengubah cara pandang seseorang sepenuhnya — dan di {loc} kami bantu kamu menemukannya. Koleksi lengkap dari novel, non-fiksi, akademik, hingga buku anak. Konsultasi rekomendasi bacaan gratis, tanpa tekanan. Hanya {dist}km. {cta}",
      "{greeting}! Toko buku bukan sekadar tempat beli buku — ini tempat kamu menemukan perspektif baru. Di {loc}, tim kami siap merekomendasikan bacaan sesuai minat, tujuan, dan level pemahamanmu. Koleksi diperbarui setiap minggu. Hanya {dist}km. {cta}",
      "{greeting}! New arrival buku bulan ini sudah masuk di {loc} — judul bestseller internasional, koleksi langka, dan buku lokal berkualitas. Stok edisi pertama selalu terbatas. Datang atau hubungi kami sekarang, hanya {dist}km. {cta}"
    ],
    "High-end Goods": [
      "{greeting}! Ada perbedaan nyata antara produk mahal dan produk berkualitas — dan di {loc} kami pastikan kamu mendapat keduanya. Koleksi luxury kami dilengkapi sertifikat keaslian, layanan personal shopper, dan after-sales yang tidak asal-asalan. Hanya {dist}km. {cta}",
      "{greeting}! Luxury bukan soal pamer — ini soal memilih yang bertahan seumur hidup. Di {loc}, kami kurasi produk premium dari heritage brand terpercaya. Tidak ada replica, tidak ada grey market. Konsultasi personal shopper gratis untuk pertama kali. Hanya {dist}km. {cta}",
      "{greeting}! Koleksi eksklusif baru tiba di {loc} — dan stok ini tidak akan restock setelah habis. Item limited edition dari brand terpilih, hanya untuk {dist}km pertama. Hubungi kami hari ini untuk reservasi sebelum terlambat. {cta}"
    ],
    "Wedding/Jewelry": [
      "{greeting}! Momen pernikahan terjadi sekali — dan perhiasan yang kamu kenakan akan menjadi kenangan selamanya. Di {loc}, kami mengerjakan custom jewelry dengan standar ketat: gold certified, pengrajin berpengalaman, konsultasi desain gratis. Hanya {dist}km. {cta}",
      "{greeting}! Tidak ada dua cincin yang persis sama — karena setiap pasangan punya cerita yang unik. Tim desainer perhiasan kami di {loc} mengerjakan custom piece dari konsep hingga selesai, dengan visualisasi 3D sebelum pengerjaan dimulai. Hanya {dist}km. {cta}",
    ...
    "Banking/Finance": [
      "{greeting}! Financial planning bukan hanya untuk yang sudah kaya — justru paling dibutuhkan ketika kamu baru mulai. Konsultan keuangan kami di {loc} membantu dari mana pun kondisi finansialmu sekarang. Konsultasi pertama gratis, tanpa komitmen. Hanya {dist}km. {cta}",
      "{greeting}! Uang yang tidak dikelola dengan strategi yang tepat akan stagnan, bahkan tergerus inflasi. Di {loc}, tim kami bantu kamu membuat rencana investasi yang realistis sesuai profil risiko dan tujuan jangka panjangmu. Hanya {dist}km. {cta}",
    ...
    "Music/Events": [
      "{greeting}! Konser dan event lokal {loc} yang kami hadirkan bukan sekadar hiburan — ini pengalaman yang akan kamu ceritakan bertahun-tahun kemudian. Lineup artis pilihan, sound system profesional, venue yang nyaman. Hanya {dist}km. {cta}",
      "{greeting}! Musisi lokal {loc} yang tampil di event kami bukan yang sembarangan — mereka adalah yang terbaik dari daerah ini, dengan kualitas yang layak panggung nasional. Dukung mereka dengan hadir langsung. Hanya {dist}km. {cta}",
      "{greeting}! Early bird sudah habis, dan tiket reguler juga hampir sold out. Event di {loc} ini hanya sekali — tidak ada penayangan ulang, tidak ada rerun. Pesan sekarang sebelum benar-benar kehabisan. Hanya {dist}km. {cta}"
    ],
    "Sustainability": [
      "{greeting}! Setiap pilihan konsumsi kita hari ini berdampak pada generasi berikutnya — dan perubahan itu dimulai dari hal kecil. Produk eco-friendly kami di {loc} sudah tersertifikasi ramah lingkungan, diproduksi etis, dan packaging minimal waste. Hanya {dist}km. {cta}",
      "{greeting}! Sustainable living bukan tren sesaat — ini perubahan cara pandang tentang konsumsi yang bertanggung jawab. Di {loc}, setiap produk yang kami jual sudah melewati seleksi ketat soal dampak lingkungan. Setiap pembelian berkontribusi pada program penanaman pohon lokal. Hanya {dist}km. {cta}",
  ...
  "meta": {
    ...
    "Literature & Education": [
      "{greeting} Buku yang tepat bisa mengubah hidupmu! 📚\n\nKoleksi terlengkap di {loc} — novel, non-fiksi, akademik, buku anak. Konsultasi rekomendasi gratis. Hanya {dist}km.\n\n{cta}",
      "{greeting} Investasi ilmu adalah yang paling menguntungkan. 🎓\n\nToko buku kami di {loc} bantu kamu temukan bacaan yang paling relevan. {dist}km dari kamu.\n\n{cta}",
      "{greeting} NEW ARRIVAL BUKU — STOK TERBATAS! 📖\n\nJudul bestseller dan koleksi langka baru masuk di {loc}. Hanya {dist}km.\n\n{cta}"
    ],
    "High-end Goods": [
      "{greeting} Luxury yang sesungguhnya — bersertifikat, terpercaya, di {loc}! 👜\n\nPersonal shopper siap membantu. Hanya {dist}km dari kamu.\n\n{cta}",
      "{greeting} Kualitas yang bertahan seumur hidup — itu definisi luxury kami. ✨\n\nKoleksi premium di {loc}, {dist}km. Sertifikat keaslian terjamin.\n\n{cta}",
      "{greeting} KOLEKSI EKSKLUSIF BARU — TIDAK AKAN RESTOCK! 🔔\n\nStok sangat terbatas di {loc}. Hubungi kami sekarang untuk reservasi.\n\n{cta}"
    ],
    "Wedding/Jewelry": [
      "{greeting} Perhiasan custom untuk momen terpenting hidupmu! 💍\n\nGold certified, pengrajin terpercaya di {loc}. Konsultasi desain gratis. Hanya {dist}km.\n\n{cta}",
      "{greeting} Cincin yang kamu kenakan hari pernikahanmu — buat jadi sempurna. 💎\n\nCustom design, visualisasi 3D, pengerjaan presisi. Di {loc}, {dist}km.\n\n{cta}",
      "{greeting} SLOT KONSULTASI GRATIS — TERSISA 4! ⏰\n\nHanya 10 pasangan, sudah 6 terisi. Di {loc}, {dist}km. Hubungi sekarang!\n\n{cta}"
    ],
    "Banking/Finance": [
      "{greeting} Financial freedom dimulai dari langkah pertama yang tepat! 💰\n\nKonsultasi keuangan gratis di {loc}. Investasi, asuransi, perencanaan — semua ada. Hanya {dist}km.\n\n{cta}",
      "{greeting} Uang yang tidak dikelola akan stagnan — yuk mulai sekarang. 📈\n\nKonsultan keuangan kami di {loc} bantu dari kondisi finansial apapun. {dist}km.\n\n{cta}",
      "{greeting} WORKSHOP KEUANGAN GRATIS — SABTU INI! 🔔\n\nHanya 30 kursi, sudah 22 terisi di {loc}. Daftar sekarang!\n\n{cta}"
    ],
    "Music/Events": [
      "{greeting} Event musik lokal terbaik ada di {loc}! 🎵\n\nLineup artis pilihan, sound profesional, pengalaman tak terlupakan. Hanya {dist}km.\n\n{cta}",
      "{greeting} Support musisi lokal {loc} yang karyanya luar biasa! 🎤\n\nLive performance terbaik — jujur, energik, berkesan. Tiket terbatas. Hanya {dist}km.\n\n{cta}",
      "{greeting} TIKET HAMPIR HABIS — PESAN SEKARANG! 🎉\n\nEvent {loc} ini hanya sekali. Tidak ada rerun. Hanya {dist}km dari kamu.\n\n{cta}"
    ],
    "Sustainability": [
      "{greeting} Pilihan konsumsi yang lebih baik, mulai dari {loc}! 🌿\n\nProduk eco-friendly bersertifikat, ramah lingkungan, packaging minimal waste. Hanya {dist}km.\n\n{cta}",
      "{greeting} Sustainable living yang praktis dan terjangkau. ♻\n\nProduk eco-certified di {loc} — setiap pembelian = tanam pohon lokal. {dist}km.\n\n{cta}",
      "{greeting} PROMO ECO-FRIENDLY — HEMAT 20% + TOTE GRATIS! 🌱\n\nStok terbatas di {loc}. Pilihan baik untuk kamu dan bumi. Hanya {dist}km.\n\n{cta}"
    ],
    "General": [
